...
| **Ours (checkpoint-18000)** | **85.6%** | — | — | — |

We currently trail Phonikud slightly. The goal is to match then exceed it — at which point the model surpasses its own training signal.
